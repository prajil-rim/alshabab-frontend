...
const SearchSection = ({
    ...
    return (
        <div className="space-y-3">
            ...
            />
            <div className="backdrop-blur-xl rounded-md flex items-center gap-14 font-manrope p-5 bg-white/54 max-w-[95%] mx-auto">
                <span className="font-semibold text-xl">Trending Searches</span>
