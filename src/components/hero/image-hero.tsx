...
>) => {
    return (
        <section
            className="relative flex flex-col justify-center items-center h-[40rem] lg:h-[35rem] 2xl:h-[50rem] bg-no-repeat bg-center bg-cover after:inset-0 after:bg-black/50 after:absolute pb-10"
            style={{
