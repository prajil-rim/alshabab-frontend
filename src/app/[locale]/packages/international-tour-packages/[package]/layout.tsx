                        ...
                        <>
                            <div className="flex justify-between items-center">
                                <TabsList className="space-x-3 font-manrope mb-6 max-w-full overflow-x-scroll scrollbar-none justify-start">
                                    <TabsTrigger value="all-packages" asChild>
                                        <Link
                                            href={`/packages/international-tour-packages/${parentPackage}`}
                                        >
                                            All Packages
                                        </Link>
                                    </TabsTrigger>
                                    {packageCategories.map(
                                        (category: {
                                            ...
                                            >
                                                <Link
                                                    href={`/packages/international-tour-packages/${parentPackage}/${category.slug}`}
                                                >
                                                    {category.category}
                                                </Link>
                                            </TabsTrigger>
